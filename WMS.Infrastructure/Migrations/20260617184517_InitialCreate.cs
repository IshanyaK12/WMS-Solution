        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientAddress = table.Column<string>(type: "varchar(max)", nullable: true),
                    ClientPhoneNumber = table.Column<decimal>(type: "numeric(10,0)", nullable: true),
                    ClientLocation = table.Column<string>(type: "varchar(20)", maxLength: 20, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Employee_Age18", "DATEDIFF(year, [DOB], GETDATE()) >= 18");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Allocation_Employees_EmpId",
                        column: x => x.EmpId,
                        principalTable: "Employees",
                        principalColumn: "EmployeeId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Allocation_Projects_ProjectId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalHours = table.Column<double>(type: "float", nullable: false, computedColumnSql: "ISNULL(DATEDIFF(MINUTE, [CheckIn], [CheckOut]) / 60.0, 0)", stored: true),
                    WorkMode = table.Column<string>(type: "varchar(20)", nullable: true),
